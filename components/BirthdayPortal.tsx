...
export default function BirthdayPortal(props: BirthdayPortalProps) {
  ...
  return (
    <div className="relative overflow-hidden" style={{ background: "var(--color-void)" }}>
      ...
      <section className="section relative flex flex-col items-center justify-center min-h-[80vh] text-center">
        <div className="star-field" aria-hidden />
        <div className="relative z-10 flex flex-col items-center">
          <div className="portal-ring mb-8" aria-hidden />
          <div className="font-display text-2xl md:text-4xl text-glow fade-up">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-display text-4xl md:text-7xl leading-tight text-glow captain-reveal-line">
            {("CAPTAIN " + upperName + "'S").split("").map((c, i) => (
              <span key={i} style={{ animationDelay: `${0.05 * i}s` }}>
                {c === " " ? "\u00A0" : c}
              </span>
            ))}
          </h1>
      ...
      <section className="section">
        <div className="max-w-2xl mx-auto card p-6 md:p-10 fade-up">
          ...
          <h3 className="font-display text-2xl md:text-3xl text-glow mt-2 mb-2">
            ATTENTION CREW
          </h3>
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-sm md:text-base">
            <div className="card p-4">
              <div className="text-comet text-xs uppercase tracking-widest">📅 Mission Date</div>
              <div className="mt-1">{formatDate(partyDate)}</div>
            </div>
            <div className="card p-4">
              <div className="text-comet text-xs uppercase tracking-widest">⏰ Launch Time</div>
              <div className="mt-1">{partyTime}</div>
            </div>
            <div className="card p-4">
              <div className="text-comet text-xs uppercase tracking-widest">📍 Mission Base</div>
              <div className="mt-1">{location}</div>
            </div>
            <div className="card p-4">
              <div className="text-comet text-xs uppercase tracking-widest">🎖 Mission Theme</div>
      ...
      <section className="section text-center">
        <h3 className="font-display text-2xl md:text-3xl text-glow mb-8">
      ...
      <section className="section text-center">
        <h3 className="font-display text-2xl md:text-3xl text-glow mb-2">
      ...
      <section className="section">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-6">
            <h3 className="font-display text-2xl md:text-3xl text-glow">
              CADET CHALLENGE
            </h3>
      ...
      <section className="section">
        <div className="max-w-xl mx-auto card p-6 md:p-8 relative overflow-hidden fade-up">
          ...
          <h3 className="font-display text-xl md:text-2xl text-glow-violet mt-1 mb-3">
            SECRET STAR LOG
          </h3>
          ...
          <div className="mt-4 text-right text-xs uppercase tracking-widest text-comet">
            ★ Mission Seal — Captain {childName}
          </div>
        </div>
      </section>
      ...
      {isDemo && (
        <section className="section text-center">
          <div className="max-w-md mx-auto card p-6">
            <h4 className="font-display text-xl text-glow mb-3">
